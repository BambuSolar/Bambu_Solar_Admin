...
class SocialNetworksControllerTest < ActionController::TestCase
  ...
  test "should create social_network" do
    assert_difference('SocialNetwork.count') do
      post :create, social_network: { icon: @social_network.icon, link: @social_network.link, name: @social_network.name, order: @social_network.order }
    end
  ...
  test "should update social_network" do
    patch :update, id: @social_network, social_network: { icon: @social_network.icon, link: @social_network.link, name: @social_network.name, order: @social_network.order }
    assert_redirected_to social_network_path(assigns(:social_network))
  end
