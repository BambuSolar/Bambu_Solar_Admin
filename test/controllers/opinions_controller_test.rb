...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { body: @opinion.body, signature: @opinion.signature, status: @opinion.status, title: @opinion.title }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { body: @opinion.body, signature: @opinion.signature, status: @opinion.status, title: @opinion.title }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
